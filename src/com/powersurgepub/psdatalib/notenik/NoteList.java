...
public class NoteList
  ...
  */
  ...
  /** 
   New notes are added to the end of notes2. Notes are never removed from
   this list. 
  */
  private List<Note>      notes2 = new ArrayList<Note>();
  
  /**
   Items in this list contain an index pointing back to a note in notes2. 
  ...
  */
  ...
  public NotePositioned add2 (Note newNote) {
    ...
    addUniqueKey(newNote, notes2.size());
  ...
  */
  ...
  private Note getNoteFromUniqueIndex (int uniqueIndexIn) {
    return notes2.get(getNoteIndexFromUniqueIndex(uniqueIndexIn));
  }
  ...
  */
  private int compareSort(int index, Note note2) {
    ...
    Note note1 = notes2.get(noteIndex);
  ...
  private Note getNoteFromSortIndex (int sortIndexIn) {
    return notes2.get(getNoteIndexFromSortIndex(sortIndexIn));
  }
  ...
  */
  ...
  /*
   Extend the Abstract Table Model for use in displaying the list of notes. 
  */
