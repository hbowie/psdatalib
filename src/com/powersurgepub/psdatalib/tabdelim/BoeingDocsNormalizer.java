...
/**
   ...
   Version History: <ul><li>
    ...
    2003/04/21 - Added lookupPath to allow lookup files to be stored
                 outside of the program folder. <li>
    2003/03/11 - Initially created this object for Boeing Mesa IT.
      </ul>
   ...
   @version  
     2004/04/28 - Made program more flexible in terms of determining which
		              folder name to get which information from. Also added output
                  column for last file modification date. Also added output 
									column to indicate standards violations in file names. Also 
                  modified code to look for a doc type code and pass it along
                  as such even if it is not included in a doc type table. 
 */
