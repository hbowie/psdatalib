...
public class MarkupWriter 
  ...
  */
  ...
  private boolean store (TextNode node) {
    ...
    if (ok) {
      ...
      ok = start (node.getType(), node.getStyle(), node.getAttributeHref(), false);
      } else {
    ...
    for (int i = 0; i < node.getChildCount(); i++) {
      store ((TextNode)node.getChildAt (i));
    }
    ...
    if (ok) {
      ...
      if (node.isSelfClosing()) {
        ...
        ok = end (node.getType(), node.getAttributeHref());
      }
    }
    ...
    if (node.getType().equals(TextType.PRE)) {
      preformatted = false;
    }
  ...
  */
  ...
  public boolean endOutline () {
    boolean ok = true;
    endXML (TextType.OUTLINE, true, true);
    return ok;
  }
  ...
  public boolean end (String tagAnyCase, String link) {
    ...
    if (tag.equals (TextType.DEFINITION_DEF)) {
      ...
      switch (markupFormat) {
        ...
        case NETSCAPE_BOOKMARKS_FORMAT:
        case XML_FORMAT:
          endXML (tag, TextData.breakBeforeClosingTag(tag),
              TextData.breakAfterClosingTag(tag));
          break;
        case OPML_FORMAT:
          break;
        case STRUCTURED_TEXT_FORMAT:
  ...
  public void endHTML () {
    switch (markupFormat) {
      ...
      case TEXTILE_SYNTAX_2_FORMAT: 
        break;
      case HTML_FORMAT:
        endXML (TextType.HTML, true, true);
        break;
      case HTML_FRAGMENT_FORMAT:
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
      case XML_FORMAT:
        endXML (TextType.HTML.toUpperCase(), true, true);
        break;
      case STRUCTURED_TEXT_FORMAT:
        break;
      default:
  ...
  public void endOPML () {
    switch (markupFormat) {
      ...
      case OPML_FORMAT:
      case XML_FORMAT:
        endXML (TextType.OPML, true, true);
        break;
      case STRUCTURED_TEXT_FORMAT:
        break;
      default:
  ...
  public void endHead () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.HEAD, true, true);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        break;
      case OPML_FORMAT:
  ...
  public void endBody () {
    switch (markupFormat) {
      ...
      case XML_FORMAT:
      case OPML_FORMAT:
        endXML (TextType.BODY, true, true);
        break;
      case STRUCTURED_TEXT_FORMAT:
  ...
  public void endHeading (int level) {
    switch (markupFormat) {
      ...
      case HTML_FORMAT:
      case HTML_FRAGMENT_FORMAT:
        endXML (TextType.HEADING_PREFIX + String.valueOf (level), true, true);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
      case XML_FORMAT:
        endXML (TextType.HEADING_PREFIX.toUpperCase() + String.valueOf (level), false, true);
        break;
      case OPML_FORMAT:
        break;
      case STRUCTURED_TEXT_FORMAT:
  ...
  public void endBlockQuote () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.BLOCK_QUOTE, true, true);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        break;
      case OPML_FORMAT:
  ...
  public void endParagraph () {
    switch (markupFormat) {
      ...
      case NETSCAPE_BOOKMARKS_FORMAT:
      case XML_FORMAT:
        endXML (TextType.PARAGRAPH, true, true);
        break;
      case OPML_FORMAT:
        startOutline (TextType.PARAGRAPH, text.toString(), "", true);
        stopStoringText();
  ...
  public void endOrderedList () {
    switch (markupFormat) {
      ...
      case NETSCAPE_BOOKMARKS_FORMAT:
      case XML_FORMAT:
        endXML (TextType.ORDERED_LIST, true, true);
        break;
      case OPML_FORMAT:
        startOutline (TextType.PARAGRAPH, text.toString(), "", true);
        stopStoringText();
  ...
  public void endUnorderedList () {
    switch (markupFormat) {
      ...
      case NETSCAPE_BOOKMARKS_FORMAT:
      case XML_FORMAT:
        endXML (TextType.UNORDERED_LIST, true, true);
        break;
      case OPML_FORMAT:
        startOutline (TextType.PARAGRAPH, text.toString(), "", true);
        stopStoringText();
  ...
  public void endListItem () {
    switch (markupFormat) {
      ...
      case NETSCAPE_BOOKMARKS_FORMAT:
      case XML_FORMAT:
        endXML (TextType.LIST_ITEM, true, true);
        break;
      case OPML_FORMAT:
        startOutline (TextType.PARAGRAPH, text.toString(), "", true);
        stopStoringText();
  ...
  public void endDefinitionList () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.DEFINITION_LIST, true, true);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        endXML (TextType.DEFINITION_LIST.toUpperCase(), true, true);
        break;
      case OPML_FORMAT:
        startOutline (TextType.PARAGRAPH, text.toString(), "", true);
        stopStoringText();
  ...
  public void endDefinitionTerm () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.DEFINITION_TERM, true, true);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        endXML (TextType.DEFINITION_TERM.toUpperCase(), true, true);
        break;
      case OPML_FORMAT:
        startOutline (TextType.PARAGRAPH, text.toString(), "", true);
        stopStoringText();
  ...
  public void endDefinitionDef () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.DEFINITION_DEF, true, true);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        endXML (TextType.DEFINITION_DEF.toUpperCase(), true, true);
        break;
      case OPML_FORMAT:
        startOutline (TextType.PARAGRAPH, text.toString(), "", true);
        stopStoringText();
  ...
  public void endTitle () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.TITLE, true, true);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        endXML (TextType.TITLE.toUpperCase(), true, true);
        break;
      case OPML_FORMAT:
        endXML (TextType.TITLE, true, true);
        break;
  ...
  public void endEmphasis () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.EMPHASIS, false, false);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        break;
      case OPML_FORMAT:
  ...
  public void endStrong () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.STRONG, false, false);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        break;
      case OPML_FORMAT:
  ...
  public void endItalics () {
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.ITALICS, false, false);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        break;
      case OPML_FORMAT:
  ...
  public void endCitation () {
    switch (markupFormat) {
      case MARKDOWN_FORMAT:
        endXML (TextType.CITATION, false, false);
        break;
      case TEXTILE_SYNTAX_1_FORMAT:
      case TEXTILE_SYNTAX_2_FORMAT: 
  ...
  public void endLink (String link) {
    ...
    switch (markupFormat) {
      ...
      case HTML_FRAGMENT_FORMAT:
      case XML_FORMAT:
        endXML (TextType.ANCHOR, false, false);
        break;
      case NETSCAPE_BOOKMARKS_FORMAT:
        if (link.length() > 0) {
          endXML (TextType.ANCHOR.toUpperCase(), false, false);
        }
        break;
      case OPML_FORMAT:
        break;
  ...
  public void startXML (TextNode node) {
    
    if (node.getData().breakBeforeOpeningTag()) {
      writer.ensureNewLine();
    }

    openTag();
    writer.write (node.getType());
    boolean emptyTag = node.getTextType().isSelfClosingTag();
    if (node.hasStyle()) {
      writeAttribute (TextType.CLASS, node.getStyle());
    }
    for (int i = 0; i < node.getChildCount(); i++) {
      TextNode child = node.getTextChildAt (i);
      if (child.isAttribute()) {
        if (child.getType().equals(TextType.CLOSING)) {
          emptyTag = true;
        }
        else
        if (epub && child.getTextType().isAttributeTarget()) {
          // Target attributes neither allowed nor needed for epubs
        }
        else
        if (node.isComment()) {
          writer.write (child.getText());
        }
        else
        if (node.isAnchor()
            && child.isAttributeHref()) {
          writeAttribute (child.getType(), epubLink(child.getText()));
        } 
        else
        if (child.getType().equalsIgnoreCase(TextType.CLASS)) {
          // Skip it, since we already wrote it out
        } else {
          writeAttribute (child.getType(), child.getText());
        }
      }
    }
    if (node.isComment()) {
    ...
    if (node.getData().breakAfterOpeningTag()) {
      writer.newLine();
      if (! emptyTag) {
        writer.moreIndent();
      }
  ...
  public void endXML (String tag, boolean breakBefore, boolean breakAfter) {
    if (breakBefore) {
      writer.ensureNewLine();
      writer.lessIndent();
    }
