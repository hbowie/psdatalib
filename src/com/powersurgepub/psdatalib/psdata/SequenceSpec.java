...
package com.powersurgepub.psdatalib.psdata;
  ...
  import com.powersurgepub.psdatalib.psdata.SequenceField;
...
/**
   ...
   @version 00/05/16 - Modified to be consistent with "The Elements of Java Style".
...
public class SequenceSpec {
  ...
  public void addField (String fieldName) {
    ...
    seqFields.addElement (new SequenceField (recDef, fieldName));
  ...
  public String toString () {
    ...
    for (int i = 0; i < seqFields.size (); i++) {
      ...
      recordBuf.append (seqFields.elementAt(i).toString());
  ...
  public SequenceField nextField () {
    ...
    return (SequenceField)seqFields.elementAt (++fieldNumber);
