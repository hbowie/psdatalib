...
/**
   ...
   Version History: <ul><li>
      2003/04/17 - Added convenience methods getCommonFormOfName,
                   to directly return the Name of the field in its common
                   form (no punctuation or spaces), and getProperName, to
                   return the name in its original, unmodified form. <li>
      2003/03/11 - Added logic to the setData method to prevent indicating
                   that the field is an integer when the passed String
                   contains no digits. Previously, a null string was being
                   treated as an integer. <li>
      2003/03/10 - Added logic to the operate method to honor an assignment
                   operator ("=") for strings as well as the concatenation
                   operator. <li>
      2003/02/10 - Added getDataBoolean method. <li>
      2002/09/22 - Corrected bug in operateLogically method. <li>
      2002/09/02 - Modified combine method to pass back more detailed
                   results. <li>
      2001/02/25 - Corrected bug in operateLogically method that caused
                   results of comparisons to be reversed. <li>
      2000/12/03 - Added equals method. <li>
      2000/12/01 - Corrected bug in integer compareTo method that caused
                   results to be opposite of what they should be.
                   Added array constants to define valid operands.
                   Added full-word operands.
                   Added "contains"operand. <li>
      2000/08/23 - Added missing "throws" comment in operateLogically method;
                   Now pass back the operator itself as part of the 
                   exception message from operateLogically;
                   Now recognize mnemonic operators in operateLogically. <li>
      2000/06/17 - Added ability to manipulate field as an integer. <li>
      2000/05/07 - Modified to be consistent with "The Elements of Java Style".</ul>
   ...
   @version 
      2004/06/01 - Added purify method call to setData method. Changed toString method
                   to return shorter string, and added toStringLong to get complete
                   details. 
 */
