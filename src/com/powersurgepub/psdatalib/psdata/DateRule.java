...
/**
   ...
   Version History: <ul><li>
        00/05/10 - Added inFormat and outFormat, to control sequence of date
                   sub-fields for input and output. <li>
        00/04/26 - Modified to be consistent with "The Elements of Java Style".
      </ul>
   ...
   @version 00/05/22 - Check for empty string and return those unchanged.
 */
