...
/**
   ...
   Version History: <ul><li>
     2002/11/19 - Added mergeSame methods to support merging a second dataset
                  that does not have its own column headings, but has same
                  record definition as first data set.
                  Added openForInput method with Record Definition as input,
                  to comply with DataSource interface.
     2002/10/12 - Added setDebug method and Debug instance to comply with 
                  modified DataSource interface. <li>
     2002/08/27 - Added code to maintain a record sequence number. 
                  Added a merge function that will add a subsequent
                  DataSource to an existing DataSet. <li>
     2002/08/20 - Added constructor to limit number of records in 
                  data set. <li>
     2001/02/28 - Added logic to return null from nextRecordIn if there
                  are no more eligible records to return. <li>
     2000/12/02 - Added logic to optionally use a data filter for
                  sequential input from this data set. <li>
     2000/11/21 - Added the getNames method to return the names
                  of all the fields in the record as a Vector. <li>
     2000/11/18 - Added code to ensure a null record is not added to
                  the data set. <li>
     2000/11/05 - Added methods to return the number of fields in each
                  record, the number of records in the dataset, and
                  to return a particular record located at a 
                  particular row number. <li>
     2000/05/17 - Modified to be consistent with "The Elements of Java Style".
      </ul>
   ...
   @version  
     2003/07/28 - Added support for passing path information.
 */
