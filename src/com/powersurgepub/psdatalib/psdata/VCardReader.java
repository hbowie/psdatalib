...
/**
   A reader that reads contact information in the form of one or more
   vCard (.vcf) files. <p>
   
   This code is copyright (c) 1999-2009 by Herb Bowie of PowerSurge Publishing.
 ...
 */
 public class VCardReader 
  ...
  public void openForInput (DataDictionary inDict) 
    ...
    newDirToExplode = new DirToExplode (1, inPath);
