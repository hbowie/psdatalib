...
public class Author 
  ...
  public void setOneCompleteName (String completeNameIn) {
    ...
    firstName = new StringBuilder (StringUtils.substringLenient 
        (completeName, firstNameStart, firstNameEnd));
    lastName = new StringBuilder (StringUtils.substringLenient 
