...
public class USPhoneRule
  ...
  public String transformMobile (String inData, boolean mobile) {
    ...
    StringBuffer work = new StringBuffer (formatted);
    if (work.length() >= STANDARD_LENGTH) {
      ...
      if (mobile) {
        StringBuffer prefixStringBuffer = new StringBuffer (prefixString);
        prefixStringBuffer.append ('M');
        prefixString = prefixStringBuffer.toString();
      }
  ...
  public String format (String inString) {
    ...
    StringBuffer work = new StringBuffer (inString);
    ...
    if ((pattern.getDigitCount() >= 11)
      && (work.charAt (0) == areaCodePrefix)) {
        work = new StringBuffer (inString.substring (1, inString.length()));
